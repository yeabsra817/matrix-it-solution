...
export default async function SchoolOfficerPage() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold">School Officer Dashboard</h2>
      <p className="text-slate-400">
        Register students, link guardians, and manage enrollment for{" "}
        {session!.schoolName} only.
      </p>
